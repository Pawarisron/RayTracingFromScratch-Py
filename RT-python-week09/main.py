...
def renderBlinn():
    ...
    mat_blinn1 = rtm.Blinn(rtu.Color(0.8, 0.5, 0.8), 0.5, 0.2, 0.08)
    mat_blinn2 = rtm.Blinn(rtu.Color(0.4, 0.5, 0.4), 0.5, 0.6, 8)
    mat_blinn3 = rtm.Blinn(rtu.Color(0.8, 0.5, 0.4), 0.5, 0.2, 300)
    ...
    renderer.render()
    renderer.write_img2png('week09_nojittered.png')    

    # renderer.render_jittered()
    # renderer.write_img2png('week09_jitter_fs5_07.png')    
